    ...
    <div className="section">
      ...
      <div className="container">
        <p>
          ...
          client work. IYCONNECT brings a total transformation across the entire
          practice, allowing any firm to maximize efficiencies, streamline
          processes and optimize the scale.
        </p>
        <br></br>
        <hr></hr>
        <br></br> <br></br>
        ...
        <div className="d-flex mb-3 service-alt">
          ...
          <div>
            <h3>Build enduring client relationships by providing a first-class
              service</h3>
            <p>
